...
const activateUserData = () => {
    ...
    axios
        .put(`/api/users/${dataIdBeingUsed.value}/activate`)
        .then((response) => {
...
const deleteData = () => {
    ...
    axios
        .delete(`/api/users/${dataIdBeingUsed.value}`)
        .then(() => {
                ...
                >
                    ...
                    <Column header="Ações" style="min-width: 12rem">
                        <template #body="{ data }">
                            <router-link
                                class="m-3"
                                :to="'/admin/users/' + data.id + '/edit'"
                                ><i class="pi pi-file-edit"></i
                            ></router-link>
                            <router-link class="m-3" :to="'/admin/users/' + data.id"
                                ><i class="pi pi-eye"></i
                            ></router-link>
                            <!-- <a
                                class="m-3"
