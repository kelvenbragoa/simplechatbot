...
const onSubmit = handleSubmit((values) => {
    ...
    axios
        .put(`/api/invitationlinks/${router.currentRoute.value.params.id}`, { ...values, date_of_birth: formattedDate })
        .then((response) => {
            // resetForm();
            router.back();
...
const getData = async (page = 1) => {
    axios
        .get(`/api/invitationlinks/${router.currentRoute.value.params.id}/edit`, {
            params: {
